...
plotreact <- function(react, deg, graph, n = 10) {
  switch(graph,
         ...
         "map" = emapplot(react, showCategory=n, cex.params = list(category_label = 1)),
         "cnet" = cnetplot(react, showCategory = n, categorySize="pvalue", color.params = list(foldChange=deg$logFC)))
}
